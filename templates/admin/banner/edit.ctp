    ...
    <tr valign="top">
      <td><!-- start id-form -->
        <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
          ...
          <tr <?=$_GET['cid']==118||$_GET['cid']==116||$_GET['cid']==117||$_GET['cid']==113?'style="display:none"':'';?>>
            <th valign="top">Link:</th>
            <td><textarea class="textboxround" name="link" ><?=$banner['link']?$banner['link']:'http://www'?></textarea>
