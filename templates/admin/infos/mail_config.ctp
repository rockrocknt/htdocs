...
<!--  start message-blue -->
    <div id="message-blue">
        <table border="0" width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td class="blue-left">Xin bạn cấu hình đầy đủ thông tin email mà bạn đã tạo trên server để có thể chạy chức năng gửi mail trên trang web của bạn.</td>
...
<!--  start message-red -->
    <div id="message-red">
        <table border="0" width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td class="red-left"><?=$_SESSION['error']?>. <a href="javascript:history.go(-1)">Xin thử lại.</a></td>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" id="product-table">
  <tbody>
    ...
    <? 
                                                    ...
                                                    <? if($stips[$i]['iftp_id'] == 2){ ?>	
    <tr>
      <td align="center"><?=$count++?></td>	
      <td><a href="admin.php?do=infos&act=mail_config_edit&id=<?=$stips[$i]["id"]?>"><?=$stips[$i]["name_vn"]?></a></td>
      <td><a title="Edit" class="icon-1 info-tooltip" href="admin.php?do=infos&act=mail_config_edit&id=<?=$stips[$i]["id"]?>"></a></td>
    </tr>
    <? } } } ?>
  </tbody>
</table>
