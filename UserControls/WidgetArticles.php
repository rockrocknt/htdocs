...
<div class="widget"  >
    ...
    <ul class="tabs-nav blog">
        <li class="active"><a href="#tab11">Xem nhiều</a></li>
        <li><a href="#tab22">Mới nhất</a></li>
    ...
    <div class="tabs-container">
        ...
        <div class="tab-content" id="tab11">
            ...
            <ul class="widget-tabs">
                ...
                <?php
                $listpost = articles::getmostviewed(5,$curcat['id']);
                for($z=0;$z<count($listpost); $z++){
                    $item = $listpost[$z];
                    $artobj = new articles($item);
                    $link = $artobj->getLink();
                    ...
                    <li>
                        <div class="widget-thumb">
                            <a href="<?= $link ?>"><img width="74" src="<?=$FullUrl?>/<?=$item['img']?>" alt="" /></a>
                        </div>

                        <div class="widget-text">
                            <h4><a href="<?= $link ?>"><?=$item['name_vn']?></a></h4>
                            <span><?=$list[2]?>/<?=$list[1]?>/<?=$list[0]?></span>
                        </div>
        ...
        <div class="tab-content" id="tab22">
            ...
            <ul class="widget-tabs">
                ...
                $listpost = articles::getlatest_cid(5,$curcat['id']);
              //  $listpost = articles::getlatest_cid(5,0);
                for($z=0;$z<count($listpost); $z++){
                    $item = $listpost[$z];
                    $artobj = new articles($item);
                    $link = $artobj->getLink();
