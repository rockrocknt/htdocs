<?
	global $db, $tags, $cat, $cat1, $cat2, $unique_key, $article, $product, $lg, $tagSql, $parentTags, $parentTagSql, $do, $homeTags, $parentTagLevel2Sql, $parentLevel2Tags;
	$cat1 = $cat;
	...
	if(!$article)
	{
		...
		$tagSql = "select tags_id, tags_keyword, tags_unique_key, tags_name, tags_num from tags where tags_active = 1 and tags_article = " . $article['id'] . " order by tags_num asc";	
